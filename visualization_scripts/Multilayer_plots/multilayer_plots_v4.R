...
Plasmid_SNPtree_SNPlocations_Heatmap <- function(location, treeInput, modifiedVCF,genePresAbsCSV, genePresAbsTAB, plot_title,
  ...
  meta <- data.table::fread("/data02/Analysis/Projects/2_CPE_Transmission/Reference_Excels/Closed_CP_Plasmids_metadata_20230301.csv", header= TRUE, sep = ",")
  
  # Mutate a new data column with both species and ST
  meta <- meta %>% mutate(Species_ST=paste0(Final_Species,"_ST",Final_ST)) 
 ...
 #  q <-  ggtree(thetree,branch.length='none') +
    #geom_tiplab(size=2) +
    geom_tippoint(size = 0.5,shape=0, color="red") + 
    geom_rootpoint() + 
    theme_tree("white") +
    geom_treescale() +
...
#=========
  ...
  # qq2 <- qq1 + ggnewscale::new_scale_fill() +
  #    geom_fruit(data=meta,geom=geom_tile,
  #               mapping = aes(y=Plasmid,x=Species_ST,fill=Final_Species),
...
# PC2
folderloc <- "/data02/Analysis/Projects/2_CPE_Transmission/AfterFeb102023/Multilayer_plots/PC2/gff/CoreGenome_AND_gubbins_cd100/"
...
Plasmid_SNPtree_SNPlocations_Heatmap(
  ...
  genePresAbsCSV=glue('{folderloc}gene_presence_absence.csv'),
  genePresAbsTAB=glue('{folderloc}gene_presence_absence.Rtab'),
  plot_title="Plasmid Cluster 2 (PC2) carrying blaNDM-1 gene",
  GenePA_offset=0.1,SpeciesST_offset=0.1,Plasmidlen_offset=0.2,SNPs_offset=0.25,Hospital_offset=0.25,
  GenePA_pwidth=2,SpeciesST_pwidth=3,Plasmidlen_pwidth=1,SNPs_pwidth=1,Hospital_pwidth=0.07, var_width=0.02
)

ggsave(filename = "/data02/Analysis/Projects/2_CPE_Transmission/AfterFeb102023/Multilayer_plots/PC2/gff/CoreGenome_AND_gubbins_cd100/PC2.jpeg", width = 17, height = 10, device='jpeg', dpi=700)

# PC3
folderloc <- "/data02/Analysis/Projects/2_CPE_Transmission/AfterFeb102023/Multilayer_plots/PC3/gff/CoreGenome_AND_gubbins_cd100/"
...
Plasmid_SNPtree_SNPlocations_Heatmap(
  ...
  genePresAbsCSV=glue('{folderloc}gene_presence_absence.csv'),
  genePresAbsTAB=glue('{folderloc}gene_presence_absence.Rtab'),
  plot_title="Plasmid Cluster 3 (PC3) carrying blaOXA-181 gene",
  GenePA_offset=0.1,SpeciesST_offset=0.1,Plasmidlen_offset=0.2,SNPs_offset=0.25,Hospital_offset=0.25,
  GenePA_pwidth=2,SpeciesST_pwidth=3,Plasmidlen_pwidth=1,SNPs_pwidth=1,Hospital_pwidth=0.07, var_width=0.02
)

ggsave(filename = "/data02/Analysis/Projects/2_CPE_Transmission/AfterFeb102023/Multilayer_plots/PC3/gff/CoreGenome_AND_gubbins_cd100/PC3.jpeg", width = 17, height = 10, device='jpeg', dpi=700)



# PC4
folderloc <- "/data02/Analysis/Projects/2_CPE_Transmission/AfterFeb102023/Multilayer_plots/PC4/gff/CoreGenome_AND_gubbins_cd100/"
...
Plasmid_SNPtree_SNPlocations_Heatmap(
  ...
  genePresAbsCSV=glue('{folderloc}gene_presence_absence.csv'),
  genePresAbsTAB=glue('{folderloc}gene_presence_absence.Rtab'),
  plot_title="Plasmid Cluster 4 (PC4) carrying blaOXA-48 gene",
  GenePA_offset=0.1,SpeciesST_offset=0.1,Plasmidlen_offset=0.2,SNPs_offset=0.25,Hospital_offset=0.25,
  GenePA_pwidth=2,SpeciesST_pwidth=3,Plasmidlen_pwidth=1,SNPs_pwidth=1,Hospital_pwidth=0.07, var_width=0.02
)

ggsave(filename = "/data02/Analysis/Projects/2_CPE_Transmission/AfterFeb102023/Multilayer_plots/PC4/gff/CoreGenome_AND_gubbins_cd100/PC4.jpeg", width = 17, height = 10, device='jpeg', dpi=700)


# PC5
folderloc <- "/data02/Analysis/Projects/2_CPE_Transmission/AfterFeb102023/Multilayer_plots/PC5/gff/CoreGenome_AND_gubbins_cd100/"
...
Plasmid_SNPtree_SNPlocations_Heatmap(
  ...
  genePresAbsCSV=glue('{folderloc}gene_presence_absence.csv'),
  genePresAbsTAB=glue('{folderloc}gene_presence_absence.Rtab'),
  plot_title="Plasmid Cluster 5 (PC5) carrying blaNDM-1 gene",
  GenePA_offset=0.1,SpeciesST_offset=0.1,Plasmidlen_offset=0.2,SNPs_offset=0.25,Hospital_offset=0.25,
  GenePA_pwidth=2,SpeciesST_pwidth=3,Plasmidlen_pwidth=1,SNPs_pwidth=1,Hospital_pwidth=0.07, var_width=0.02
)

ggsave(filename = "/data02/Analysis/Projects/2_CPE_Transmission/AfterFeb102023/Multilayer_plots/PC5/gff/CoreGenome_AND_gubbins_cd100/PC5.jpeg", width = 17, height = 10, device='jpeg', dpi=700)
