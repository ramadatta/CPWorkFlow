...
p4 <- Plasmid_Persistence(plot_title="Persistence of **Plasmid Cluster4** (PC4) carrying blaOXA-48 gene",
                    ...
                    CC_annotlabel_x=as.Date("201-02-01"),CC_annotlabel_y=22,
...
p1
ggsave(filename = "PC1.jpeg", width = 10, height = 9, device='jpeg', dpi=700)
p2
ggsave(filename = "PC2.jpeg", width = 10, height = 9, device='jpeg', dpi=700)
p3
