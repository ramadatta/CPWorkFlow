...
Plasmid_Persistence <- function(plot_title,clusterNum){
...
gg1 <- subset_clusterNum %>%
  ...
  annotate(geom = "richtext", x = as.Date("2011-10-15"), y = 210,  label = CC_countlabel,fill = NA, family= "Roboto Condensed", label.color = NA) +
...
Plasmid_Persistence(plot_title="Persistence of **Plasmid Cluster1** (PC1) carrying blaKPC-2 gene",clusterNum="PC1")
Plasmid_Persistence(plot_title="Persistence of **Plasmid Cluster2** (PC2) carrying blaNDM-1 gene",
                    CC_countlabel_x=as.Date("2011-10-15"),
                    CC_annotlabel_x=as.Date("2012-02-01"),
                    HGT_annotlabel_x=as.Date("2012-02-01"),
                    clusterNum="PC2")
Plasmid_Persistence(plot_title="Persistence of **Plasmid Cluster3** (PC3) carrying blaOXA-181 gene",clusterNum="PC3")
Plasmid_Persistence(plot_title="Persistence of **Plasmid Cluster4** (PC4) carrying blaOXA-48 gene",clusterNum="PC4")
Plasmid_Persistence(plot_title="Persistence of **Plasmid Cluster5** (PC5) carrying blaNDM-1 gene",clusterNum="PC5")
