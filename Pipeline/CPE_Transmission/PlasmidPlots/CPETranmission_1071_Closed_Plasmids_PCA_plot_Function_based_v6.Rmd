...
Phylodynamics_staticplot <- function(plot_title,cpgene){
  #View(meta)
...
Phylodynamics_dynamicplot <- function(plot_title,cpgene){
  #View(meta)
  # Subsetting to a smaller set for ease of simplicity - selecting OXA-48 Plasmids records with n=41 rows
  subset_cpgene <- meta %>% 
    filter(CP_Gene == cpgene) %>% 
...
Phylodynamics_staticplot(plot_title="Phylodynamics of blaNDM-1 gene tranmission",cpgene="blaNDM1")
Phylodynamics_dynamicplot(plot_title="Phylodynamics of blaNDM-1 gene tranmission",cpgene="blaNDM1")

Phylodynamics_staticplot(plot_title="Phylodynamics of blaNDM-7 gene tranmission",cpgene="blaNDM7")
Phylodynamics_dynamicplot(plot_title="Phylodynamics of blaNDM-7 gene tranmission",cpgene="blaNDM7")

Phylodynamics_staticplot(plot_title="Phylodynamics of blaKPC2 gene tranmission",cpgene="blaKPC2")
Phylodynamics_dynamicplot(plot_title="Phylodynamics of blaKPC2 gene tranmission",cpgene="blaKPC2")

Phylodynamics_staticplot(plot_title="Phylodynamics of blaOXA-48 gene tranmission",cpgene="blaOXA48")
Phylodynamics_dynamicplot(plot_title="Phylodynamics of blaOXA-48 gene tranmission",cpgene="blaOXA48")

Phylodynamics_staticplot(plot_title="Phylodynamics of blaOXA232 gene tranmission",cpgene="blaOXA232")
Phylodynamics_dynamicplot(plot_title="Phylodynamics of blaOXA232 gene tranmission",cpgene="blaOXA232")

Phylodynamics_staticplot(plot_title="Phylodynamics of blaOXA181 gene tranmission",cpgene="blaOXA181")
Phylodynamics_dynamicplot(plot_title="Phylodynamics of blaOXA181 gene tranmission",cpgene="blaOXA181")
```
